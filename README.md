...
- The script reads your eBird password from the config file stored in plain text on your computer.
  ...
  - The password is stored in the ```cfg['pw']``` variable (see lines ```127-138```, and is only sent to the eBird login page (see lines ```133-147```. Examine the code before running.
